function E = CosineElement(Element,lambda,psi,theta,varargin) %#ok<INUSL>
%% function E = CosineElement(Element,lambda,psi,theta)
% function E = CosineElement(Element,lambda,psi,theta,lambda,gammar,thetar,psir)
%
