...
\lstinputlisting[firstline=2,lastline=37,caption={\texttt{PlotArray.m}},label={lst:PlotArray}]{../../mdl/PlotArray.m}
...
\lstinputlisting[firstline=2,lastline=37,caption={\texttt{BeamPattern.m}},label={lst:BeamPattern}]{../../mdl/BeamPattern.m}
